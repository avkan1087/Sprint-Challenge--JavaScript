...
const universities = [];
graduates.forEach((universityName) => universities.push(`${universityName.university}`));
...
const contactInfo = [];
graduates.forEach((firstNameEmail) => contactInfo.push(`${firstNameEmail.first_name} ${firstNameEmail.email}` ));
...
const displayNames = [];
zooAnimals.forEach((nameScientific) => displayNames.push(`Name: ${nameScientific.animal_name} Scientific: ${nameScientific.scientific_name}`));
